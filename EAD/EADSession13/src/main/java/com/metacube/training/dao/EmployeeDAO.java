...
public class EmployeeDAO {
	...
	public Status updateEmployee(Employee employee) {
		boolean result = jdbcTemplate.update(Queries.UPDATE_EMPLOYEE_BY_CODE, employee.getFirstName(),
				employee.getMiddleName(), employee.getLastName(), employee.getDob(), employee.getGender(),
				employee.getEmailId(), employee.getSkills(), employee.getCode()) > 0;
		if (result == true) {
