...
public class AdminController {
	...
	/*
	 * @GetMapping("") public String adminLogin() { return "admin/login"; }
	 * 
	 * @RequestMapping(value = "/login", method = RequestMethod.POST) public
	 * ModelAndView adminLoginDetails(@RequestParam("email") String email,
	 * 
	 * @RequestParam("password") String password) { if ("admin".equals(email) &&
	 * "admin".equals(password)) { session.setAttribute("email", email); return
	 * new ModelAndView("admin/dashboard", "email", email); } else { String
	 * error = "Invalid user or password"; return new
	 * ModelAndView("admin/login", "error", error); } }
	 */
	...
	public String searchEmployee(Model model,
		...
		model.addAttribute("employees",
				adminService.searchEmployees(firstName, lastName));
		return "admin/allEmployees";
	}
